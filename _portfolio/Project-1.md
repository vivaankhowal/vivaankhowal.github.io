...
The hilt itself was designed from scratch and went through multiple iterations, but the chassis CAD was found online on this printables that I downloaded and edited to fit my specific components. I take no credit for the chassis design, therefore here is the link from where I found the chassis:
